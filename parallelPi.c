...
int main(int argc, char *argv[]) {
	...
	if(argc < 2) {
		printf("Missing arguments for number of rectangles\n");
		return 1;
	}
	...
	if(my_rank == 0) {
		...
		printf("Result is %f with %d processes\n", result, n);
		printf("The actual value of pi is 3.14159265\n");
	}
